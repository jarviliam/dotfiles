...
as.KeyMap("n", l .. "nb", ":Telescope buffers<CR>")
as.KeyMap("n", l .. "nh", ":Telescope help_tags<CR>")
as.KeyMap("n", l .. "nq", ":Telescope quickfix<CR>")
as.KeyMap("n", l .. "nl", ":Telescope loclist<CR>")
